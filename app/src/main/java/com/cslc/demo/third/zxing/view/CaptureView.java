package com.cslc.demo.third.zxing.view;
...
public class CaptureView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int widthLen = (int) (width * 0.9);
		int heightLen = (int) (width * 0.5);
		frame.left = width / 2 - widthLen / 2;
		frame.right = width / 2 + widthLen / 2;
		frame.top = height / 2 - heightLen / 2;
		frame.bottom = height / 2 + heightLen / 2;
