...
//    };
	...
	private int tabCurrentTextColor = 0xFFEB6100;
...
//		a.recycle();
		...
		tabCurrentTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsCurrentTextColor, tabCurrentTextColor);
...
//		}
	...
	private void setSelectTextColor(int position) {
		for (int i = 0; i < tabCount; i++) {
			...
			if (position == i) {
				tv.setTextColor(tabCurrentTextColor);
			} else {
